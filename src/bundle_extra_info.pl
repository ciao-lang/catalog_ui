...
:- doc(title, "Extra bundle info"). % (for catalog)
...
% ---------------------------------------------------------------------------
:- doc(section, "Ad-hoc bundle info").
...
:- use_module(lpdoc(autodoc_lookup), [get_bundle_readme/2]).
